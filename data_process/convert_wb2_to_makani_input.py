...
def convert(input_file: str, output_dir: str, metadata_file: str, years: List[int],
    ...
    ### BEGIN EDIT
    # Add chunks={} to prevent loading everything at once, and storage_options for public access
    wb2_data = xr.open_dataset(input_file, engine="zarr", chunks={}, storage_options={'token': 'anon'})
    ### END  EDIT
