...
# import earth2studio.data as data
# from earth2studio.models.auto import Package
# from utils import create_initialization_file, compute_ivt #filename_to_year, datetime_range, open_hdf5 # these aren't used in this script currently
...
#             with torch.no_grad():
#                 io = deterministic([start_datetime], n_steps, model, initial_data, io, 
#                 # variables_list=variables_to_save # disabiled for now to access all variables for IVT calculation
#                 )
...
#                 #### compute ivt here ####
#                 if compute_ivt:
#                     ivt_da = compute_ivt(ds, bounding_box)
...
#             # Cleanup per initialization
#             del io; del ds; del ivt_da; gc.collect()
